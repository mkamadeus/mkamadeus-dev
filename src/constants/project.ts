const projects = [
  {
    ...
    description:
      "Student ID finder for ITB students. Static site with no backend.",
  ...
  },
  {
    ...
    description:
      "Fullstack system for managing and calculating score for use in FTMD ITB",
    stacks: [
      "typescript",
      "fastify",
      "prisma",
  ...
  },
  {
    ...
    description:
      "Makeshift QR code based RSVP system mainly relying on Google Suite",
